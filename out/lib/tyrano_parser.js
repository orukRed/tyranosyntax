"use strict";
// ティラノスクリプト本体にあるkag.parser.jsとほぼ同ファイルです。
// 構文解析に使用
//exportされてないメソッドのテスト
//https://nazomikan.hateblo.jp/entry/2013/04/10/032410
//nodejsでjqueryを動かす方法　これに記載のjsgomのGithubのreadmeのとおりに動かす
//https://pojiropocket.hatenablog.com/entry/2017/05/06/102801
//jsdomのGithubのreadmeに記載の合ったjqueryの使い方
...
module.exports.parseScenario = function (text_str) {
  // let tyrano = null;
  // let kag = null;
  // let flag_script = false; //スクリプト解析中なら
  // let deep_if = 0;
  var array_s = [];
...
//# sourceMappingURL=tyrano_parser.js.map