...
tyrano.plugin.kag.tag.movie = {
    ...
    playVideo: function (pm) {
        ...
        //document.getElementById("tyrano_base").appendChild(video);
        $("#tyrano_base").append(j_video);
        j_video.animate({ opacity: '1' }, { duration: parseInt(pm.time),
            complete: function () {
                //$(this).remove();
                //that.kag.ftag.nextOrder();
                //if(pm.wait=="true"){
...
tyrano.plugin.kag.tag.stop_bgmovie = {
    ...
    start: function (pm) {
        ...
        $(".tyrano_base").find("video").animate({ opacity: '0' }, { duration: parseInt(pm.time),
            complete: function () {
                $(this).remove();
                if (pm.wait == "true") {
                    that.kag.ftag.nextOrder();
...
//# sourceMappingURL=kag.tag_ext.js.map