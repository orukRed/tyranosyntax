...
tyrano.plugin.kag.ftag = {
    ...
    nextOrder: function () {
        ...
        */
        ...
        if ((tag.name == "call" && tag.pm.storage == "make.ks") ||
        ...
        (function (jtext) {
            ...
            */
            ...
            var pchar = function (index) {
                // 一文字ずつ表示するか？
                var isOneByOne = (that.kag.stat.is_skip != true
...
tyrano.plugin.kag.tag.fuki_chara = {
    ...
    start: function (pm) {
        ...
        if (pm.opacity == "")
            delete pm.opacity;
        if (pm.border_size == "")
            delete pm.border_size;
        if (pm.border_color == "")
            delete pm.border_color;
        if (pm.radius == "")
            delete pm.radius;
        if (pm.font_size == "")
            delete pm.font_size;
        if (pm.font_color == "")
            delete pm.font_color;
        if (pm.name == "others") {
...
tyrano.plugin.kag.tag.image = {
    ...
    start: function (pm) {
        ...
        if (pm.layer != "base") {
            ...
            if (pm.time == 0 || pm.time == "0")
                pm.time = ""; // integer 0 and string "0" are equal to ""
            if (pm.time != "") {
...
//# sourceMappingURL=kag.tag.js.map