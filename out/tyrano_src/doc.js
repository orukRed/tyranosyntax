"use strict";
var jQuery = require("./libs/jquery-3.4.1.min.js");
function object(o) {
...
// tyrano.plugin = {};
// tyrano.plugin.kag = {};
module.exports.tyrano = {};
module.exports.tyrano.plugin = {};
module.exports.tyrano.plugin.kag = {};
(function ($) {
    ...
    $.putHtml = function (map_doc, master_tag) {
        ...
        for (key in map_doc) {
            ...
            if (typeof obj.demo != "undefined") {
                ...
                var demo_url = "/demogame/tech_samples_" +
                    $.trim(array_demo[0]) +
