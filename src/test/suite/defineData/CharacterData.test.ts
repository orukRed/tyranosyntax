...
suite("CharacterData", () => {
  ...
  suite("face management", () => {
    test("正常系 face追加", () => {
      // 値定義
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const faceLocation = new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10));
    ...
    test("正常系 複数face追加", () => {
      // 値定義
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const face1 = new CharacterFaceData("test", "happy", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10)));
      const face2 = new CharacterFaceData("test", "sad", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(2, 0, 2, 10)));
    ...
    test("正常系 faceをファイルパスで削除", () => {
      ...
      const face1 = new CharacterFaceData("test", "happy", new vscode.Location(vscode.Uri.file(file1), new vscode.Range(1, 0, 1, 10)));
      const face2 = new CharacterFaceData("test", "sad", new vscode.Location(vscode.Uri.file(file2), new vscode.Range(2, 0, 2, 10)));
      
      characterData.addFace(face1);
      characterData.addFace(face2);

      // 実行
      characterData.deleteFaceByFilePath(file1);

      // アサート
      assert.strictEqual(characterData.faceList.length, 1);
      assert.strictEqual(characterData.faceList[0], face2);
    });

    test("正常系 存在しないファイルパスでface削除", () => {
      // 値定義
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const face = new CharacterFaceData("test", "happy", new vscode.Location(vscode.Uri.file("/test1.ks"), new vscode.Range(1, 0, 1, 10)));
      characterData.addFace(face);
  ...
  suite("layer management", () => {
    test("正常系 layer追加", () => {
      ...
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const part = "mouth";
      const layerData = new CharacterLayerData("test", part, "smile", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10)));
    ...
    test("正常系 同じpartに複数layer追加", () => {
      ...
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const part = "mouth";
      const layer1 = new CharacterLayerData("test", part, "smile", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10)));
      const layer2 = new CharacterLayerData("test", part, "sad", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(2, 0, 2, 10)));
    ...
    test("正常系 異なるpartにlayer追加", () => {
      ...
      const part1 = "mouth";
      const part2 = "eyes";
      const layer1 = new CharacterLayerData("test", part1, "smile", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10)));
      const layer2 = new CharacterLayerData("test", part2, "open", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(2, 0, 2, 10)));
    ...
    test("正常系 layerをファイルパスで削除", () => {
      ...
      const file1 = "/test1.ks";
      const file2 = "/test2.ks";
      const layer1 = new CharacterLayerData("test", part, "smile", new vscode.Location(vscode.Uri.file(file1), new vscode.Range(1, 0, 1, 10)));
      const layer2 = new CharacterLayerData("test", part, "sad", new vscode.Location(vscode.Uri.file(file2), new vscode.Range(2, 0, 2, 10)));
  ...
  suite("setters", () => {
    test("正常系 faceList setter", () => {
      ...
      const characterData = new CharacterData("test", "テスト", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(0, 0, 0, 10)));
      const newFaceList = [
        new CharacterFaceData("test", "happy", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10))),
        new CharacterFaceData("test", "sad", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(2, 0, 2, 10)))
      ];
    ...
    test("正常系 layer setter", () => {
      ...
      newLayer.set("mouth", [new CharacterLayerData("test", "mouth", "smile", new vscode.Location(vscode.Uri.file("/test.ks"), new vscode.Range(1, 0, 1, 10)))]);
