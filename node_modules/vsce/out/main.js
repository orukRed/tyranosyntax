...
module.exports = function (argv) {
    ...
    commander_1.default
        ...
        .action((version, { out, target, message, gitTagVersion, updatePackageJson, githubBranch, gitlabBranch, rewriteRelativeLinks, baseContentUrl, baseImagesUrl, yarn, ignoreFile, gitHubIssueLinking, gitLabIssueLinking, dependencies, preRelease, }) => main((0, package_1.packageCommand)({
        packagePath: out,
        version,
        target,
    ...
    commander_1.default
        ...
        .option('--no-dependencies', 'Disable dependency detection via npm or yarn')
        .option('--pre-release', 'Mark this package as a pre-release')
        .action((version, { pat, target, message, gitTagVersion, updatePackageJson, packagePath, githubBranch, gitlabBranch, baseContentUrl, baseImagesUrl, yarn, noVerify, ignoreFile, dependencies, preRelease, }) => main((0, publish_1.publish)({
        pat,
        version,
        targets: target,
        commitMessage: message,
    ...
    commander_1.default
        ...
        .action((text, { json }) => main((0, search_1.search)(text, json)));
